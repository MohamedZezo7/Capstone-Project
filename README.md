...
<img src="static/SharkDefense-normal.png"  width="350" height="88">


# SharkDefense

A phishing domain detection tool that also allows you to safely view the website without actually visiting it. Built using Python. With SharkDefense, you can quickly identify suspicious websites and protect yourself from phishing attacks.


## Features

These are the features provided by SharkDefense to its users.
...
- SharkDefense gives a trust score to the URL, which will provide the user an understanding of the trustability and authenticity of the domain.
- The URL is checked with a phish database (PhishTank) to see whether it is a reported phishing link.
- SharkDefense provides crucial details (WHOIS, SSL and general) regarding the domain, which will help the user to get a basic understanding of the URL.

## Demo


<img src="static/SharkDefense-screenshot.png"  width="350" height="175">
<br>
...
```shell
git clone https://github.com/abhizaik/SharkDefense.git
cd SharkDefense
```
...
## Learn and Contribute to the Project
  ...
  <details>
  <summary> <b> Learn How SharkDefense Works </b> </summary>
...
- `/preview`: Endpoint to view a preview of the website within SharkDefense.
- `/source-code`: Endpoint to view the source code of a website.

[Detailed code documentaion of SharkDefense](README-HOW-SAFESURF-WORKS.md)
...
<details>
  <summary> <b> How to Contribute to SharkDefense </b> </summary>
...
```shell
git clone https://github.com/yourusername/SharkDefense.git
```
